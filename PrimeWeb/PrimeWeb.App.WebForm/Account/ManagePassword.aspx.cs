    ...
    public partial class ManagePassword : System.Web.UI.Page
    {
        ...
        protected void ChangePassword_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                IdentityResult result = manager.ChangePassword<User, int>(User.Identity.GetUserId<int>(), CurrentPassword.Text, NewPassword.Text);
                if (result.Succeeded)
                {
        ...
        protected void SetPassword_Click(object sender, EventArgs e)
        {
            ...
            {
                var manager = Context.GetOwinContext().GetUserManager<ApplicationUserManager>();
                IdentityResult result = manager.AddPassword<User, int>(User.Identity.GetUserId<int>(), password.Text);
                if (result.Succeeded)
                {
